...
const Result = () => {
  ...
  // these is to display the different buttons according to use .
  const [isImageLoaded,setIsImageLoaded] = useState(false);
  // these is to display the loading 
  const [loading,setLoading] = useState(false);
  // for storing the data from the input field
  const [input ,setInput] = useState('');
const {generateImage} = useContext(AppContext)

  // when the form submit the data where should it goes that we will provide here.
