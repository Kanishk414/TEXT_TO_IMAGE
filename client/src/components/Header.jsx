...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        >
            <p>Top AI tool for turning text into stunning visuals</p>
        ...
        >Unleash your creativity with AI. Turn your imagination into stunning visuals in seconds – just type, and let the art unfold</motion.p>
        ...
        className='mt-2 text-neutral-600'>Generated images from text to image</motion.p>
    </motion.div>
  )
}
